<div class="wrap shopp">
	...
	<h2><?php _e('Memberships','Shopp'); ?> <a href="<?php echo esc_url( add_query_arg(array('page'=>ShoppAdmin::pagename('memberships'),'id'=>'new'),admin_url('admin.php'))); ?>" class="button add-new"><?php _e('Add New','Shopp'); ?></a></h2>
